...
@Comment {
    Покрыть все не получится, поэтому минимальная задача писать код тестируемо.
    Новый баг -> Написать тест
    Роль тестировщика находить такие баги, про которые забыл разработчик
}
