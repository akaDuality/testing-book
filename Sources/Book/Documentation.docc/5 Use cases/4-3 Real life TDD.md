...
Зависимостей в проекте должно быть не очень много и главный критерий для них — завимиости должны переиспользоватсья как можно больше.
